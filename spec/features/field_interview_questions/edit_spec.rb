...
RSpec.describe 'Field Interview Question Edit page' do
  before :each do
    report = [
  ...
  describe "Happy path" do
    describe "As a logged in user when I visit the page it" do
      ...
      it "shows a field to add the question and notes" do
        visit edit_part_field_interview_question_path(@part, @field_interview_question)
      ...
      it "updates the object and redirects to the section show page when the Update button is clicked" do
        ...
        within "#part-#{@part.id}" do
          within ".field_interview_questions" do
            within "#field_interview_question-#{@field_interview_question.id}" do
      ...
      it "retrurns to the Edit page if the question is not provided" do
        ...
        expect(current_path).to eq(edit_part_field_interview_question_path(@part, @field_interview_question))
      end
