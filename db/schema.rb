...
ActiveRecord::Schema.define(version: 2021_09_25_174914) do
  ...
  create_table "field_interview_questions", force: :cascade do |t|
    t.string "question"
    t.string "notes"
    t.bigint "part_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["part_id"], name: "index_field_interview_questions_on_part_id"
    t.index ["user_id"], name: "index_field_interview_questions_on_user_id"
  end

  create_table "field_interviews", force: :cascade do |t|
    t.date "date"
    t.time "time"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["section_id"], name: "index_field_interviews_on_section_id"
    t.index ["user_id"], name: "index_field_interviews_on_user_id"
  end
  ...
  add_foreign_key "field_interview_questions", "parts"
  add_foreign_key "field_interview_questions", "users"
  add_foreign_key "field_interviews", "sections"
  add_foreign_key "field_interviews", "users"
